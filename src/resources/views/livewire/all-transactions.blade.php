<div>
    {{-- Aggregate balance card: Cleared + Pending = Working (across all accounts) --}}
    ...
    <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg px-5 py-4">
        <div class="flex flex-wrap items-center gap-x-6 gap-y-3">
            ...
            <span class="text-2xl text-gray-300 dark:text-gray-600 font-light">=</span>
            <div>
                <p class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">Total Working Balance</p>
    ...
    <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg mt-8">
        <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between">
            <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">Upcoming &amp; Scheduled</h3>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg mt-8">
            ...
            <div class="p-6 space-y-3">
                <form wire:submit="addTransaction"
                    ...
                    <div>
                        <x-input-label for="newAmount" value="Amount" />
                        <x-text-input id="newAmount" wire:model="newAmount" type="number" class="mt-1 block w-32"
    ...
    <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg mt-8">
        <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700 flex flex-wrap items-center gap-3 justify-between">
            <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">All Transactions</h3>
