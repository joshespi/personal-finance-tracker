        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('manual-assets.update', $manualAsset) }}" class="space-y-6">
                    ...
                    {{-- Valuation method --}}
                    <div x-data="{ tracking: '{{ old('tracking_method', $manualAsset->tracking_method) }}' }">
                        ...
                        <div x-show="tracking === 'proxy_ticker'" x-cloak
                            ...
                            <div>
                                ...
                                <x-text-input id="proxy_symbol" name="proxy_symbol" type="text" class="mt-1 block w-32"
                                              :value="old('proxy_symbol', $manualAsset->proxyAsset?->symbol)" maxlength="20"
                                              placeholder="IWB" style="text-transform:uppercase" />
                            ...
                            <div class="flex flex-wrap gap-4">
                                <div>
                                    ...
                                    <x-text-input id="anchor_value" name="anchor_value" type="number" class="mt-1 block w-40"
                                                  :value="old('anchor_value', $manualAsset->anchor_value)" min="0" step="any" placeholder="50000.00" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="anchor_date" name="anchor_date" type="date" class="mt-1 block w-40"
                                                  :value="old('anchor_date', $manualAsset->anchor_date?->format('Y-m-d'))" />
